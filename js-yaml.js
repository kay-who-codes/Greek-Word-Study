    ...
    return function c(p, T, l) {
                ...
                N = (U = b ? i.explicitTypes : i.implicitTypes).length; S < N; S += 1)
                    if (((A = U[S]).instanceOf || A.predicate) && (!A.instanceOf || typeof g == "object" && g instanceof A.instanceOf) && (!A.predicate || A.predicate(g))) {
                        ...
                        A.represent) {
                            ...
                            r.call(A.represent) === "[object Function]")
                                j = A.represent(g, w);
                            else {
        ...
        5: [function(c, p, T) {
            ...
            function it(t, f, d, F, m, i, g, b) {
                ...
                if (Array.isArray(m))
                    for (j = 0,
                    U = (m = Array.prototype.slice.call(m)).length; j < U; j += 1)
                ...
                F === "tag:yaml.org,2002:merge")
                    ...
                    t.json || o.call(d, m) || !o.call(f, m) || (t.line = g || t.line,
            ...
            function Ct(t) {
                ...
                i ? t.tag = F : o.call(t.tagMap, d) ? t.tag = t.tagMap[d] + F : d === "!" ? t.tag = "!" + F : d === "!!" ? t.tag = "tag:yaml.org,2002:" + F : E(t, 'undeclared tag handle "' + d + '"'),
                !0
            }
            function kt(t) {
                var f, d;
            ...
            function J(t, f, d, F, m) {
                ...
                t.tag !== null && t.tag !== "!")
                    if (t.tag === "?") {
                        ...
                        o.call(t.typeMap[t.kind || "fallback"], t.tag) ? (S = t.typeMap[t.kind || "fallback"][t.tag],
            ...
            function Et(t) {
                ...
                !(0 < t.lineIndent || m !== 37)); ) {
                    ...
                    m !== 0 && rt(t),
                    o.call(wt, d) ? wt[d](t, d, F) : et(t, 'unknown document directive "' + d + '"')
                }
                H(t, !0, -1),
        ...
        6: [function(c, p, T) {
            ...
            e.prototype.toString = function(a) {
                var s, r = "";
                return this.name && (r += 'in "' + this.name + '" '),
        ...
        25: [function(c, p, T) {
            ...
            p.exports = new l("tag:yaml.org,2002:pairs",{
                ...
                resolve: function(a) {
                    ...
                    r = x.length; s < r; s += 1) {
                        if (o = x[s],
                        e.call(o) !== "[object Object]" || (u = Object.keys(o)).length !== 1)
                            return !1;
                        h[s] = [u[0], o[u[0]]]
                    }
                    return !0
